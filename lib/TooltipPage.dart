...
class TooltipPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Tooltip", style: TextStyle(color: Colors.white)),
          ...
          Expanded(
              ...
              child: Center(
                child: Chip(label: Text("flutter"),
                  avatar: Icon(Icons.add, color: Colors.lightBlueAccent),
...
class _TooltipOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ThemeData darkTheme = ThemeData(
      ...
      textTheme: TextTheme(
          body2: TextStyle(color: Colors.white, fontSize: 14.0)),
              ...
              child: ConstrainedBox(
                ...
                child: Container(
                  ...
                  child: Center(
                    ...
                    child: Text(message, style: darkTheme.textTheme.body2),
                  ),
                ),
              ),
            ),
